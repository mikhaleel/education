...
if(
 ...
 //   echo '<script>alert("'.$trows["department"].'")</script>';
	 ...
	 elseif($checkq->rowCount() == 0)
	 {
      ...
      $stdidd = encryptor("encrypt",$strows["id"]);
      ...
      $_SESSION["pageaccess"] = "fromstudents";
		  $_SESSION["studeymode"] = encryptor("encrypt","Full Time");			
          echo '<div class="alert alert-success outline alert-dismissible fade show" role="alert"><i data-feather="thumbs-up"></i><b>Wait,</b> loading dashboard....</div><script>setTimeout(function(){location.href="student/index?matno='.$stdidd.'"},20)</script>';
        }
